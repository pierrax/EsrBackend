...
User.create(email: 'admin@esr.com', password: 'password', first_name: 'Hade', last_name: 'Mine')
...
######### TAG CATEGORIES #########
InstitutionTagCategory.create(title: 'n_groupe_zone_uai', origin: 'bcn')
InstitutionTagCategory.create(title: 'n_ministere_tutelle', origin: 'bcn')
InstitutionTagCategory.create(title: 'n_secteur_public_prive', origin: 'bcn')
...
InstitutionTag.create(short_label: "EDUC NAT", long_label: "ministere de l'education nationale", institution_tag_category_id: 2)
...
InstitutionTag.create(short_label: "", long_label: "Communauté d'universités et établissements", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "École normale supérieure", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "École supérieure du professorat et de l'éducation", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "Écoles habilitées à délivrer un diplôme d'ingénieur", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "Écoles nationales supérieures d'ingénieurs", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "Établissements d'enseignement supérieur privés rattachés à un EPSCP", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "Grand établissement", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "Institut national polytechnique", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "Institut universitaire de formation des maîtres", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "Instituts et écoles extérieurs aux universités", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "Université", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "Autre établissement", institution_tag_category_id: 5)
InstitutionTag.create(short_label: "", long_label: "Université", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "École d'ingénieurs", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Grand établissement", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Autre établissement", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Communauté d'universités et établissements", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Instituts et écoles extérieurs aux universités", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Grand établissement relevant d'un autre département ministériel", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Écoles nationales supérieures d'ingénieurs", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Institut d'étude politique", institution_tag_category_id: 6)
...
InstitutionTag.create(short_label: "", long_label: "Établissement privé d'enseignement universitaire", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Association d'établissements", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "École française à l'étranger", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Etablissement relevant d'un autre département ministériel rattaché à un EPSCP", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "École normale supérieure", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Établissements d'enseignement supérieur privés rattachés à un EPSCP", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Établissement supérieur d'architecture", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Institut national polytechnique", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Pôle de recherche et d'enseignement supérieur", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "École extérieure relevant d'un autre département ministériel", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Écoles habilitées à délivrer un diplôme d'ingénieur", institution_tag_category_id: 6)
InstitutionTag.create(short_label: "", long_label: "Université pluridisciplinaire avec santé", institution_tag_category_id: 7)
InstitutionTag.create(short_label: "", long_label: "Université pluridisciplinaire hors santé", institution_tag_category_id: 7)
InstitutionTag.create(short_label: "", long_label: "Université tertiaire - lettres et sc. Humaines", institution_tag_category_id: 7)
InstitutionTag.create(short_label: "", long_label: "Université scientifique et/ou médicale", institution_tag_category_id: 7)
InstitutionTag.create(short_label: "", long_label: "Université tertiaire - droit et économie", institution_tag_category_id: 7)
...
InstitutionTag.create(short_label: "", long_label: "siege", institution_tag_category_id: 9)
InstitutionTag.create(short_label: "", long_label: "non_siege", institution_tag_category_id: 9)
InstitutionTag.create(short_label: "", long_label: "Établissement d’enseignement supérieur privé d’intérêt général", institution_tag_category_id: 10)
InstitutionTag.create(short_label: "", long_label: "Opérateurs MIRES 2014", institution_tag_category_id: 11)
InstitutionTag.create(short_label: "", long_label: "Non_Opérateur_LOLF_2014", institution_tag_category_id: 11)
InstitutionTag.create(short_label: "", long_label: "Opérateurs LOLF Hors MIRES 2014", institution_tag_category_id: 11)
InstitutionTag.create(short_label: "", long_label: "Opérateurs MIRES 2015", institution_tag_category_id: 11)
